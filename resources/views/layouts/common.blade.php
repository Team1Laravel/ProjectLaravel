...
if (Auth::check()) {
    ...
    $package_user = DB::select("SELECT b.name from payment a join package b on a.package_id = b.id where a.status = 2 and a.user_id = $user_id");
    $package_name = null;
    if (count($package_user) > 0) {
        $package_name = $package_user[0]->name;
    }
}
?>
<!DOCTYPE html>
                                ...
                                @else
                                    ...
                                    <li class="header__nav-item ml-2">
                                        ...
                                        <ul class="dropdown-menu header__dropdown-menu"
                                            ...
                                            <li>
                                                <a href="catalog1.html"><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                            ...
                                            @endphp
                                            <li><a href="{{ route('profile') }}" class="header__nav-link">Profile</a>
                                            </li>
                                        </ul>
                                    </li>
                                @endguest
