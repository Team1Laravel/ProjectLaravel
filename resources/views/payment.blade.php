...
@section('content')
        ...
        <div class='window'>
            <div class='order-info' style="background-color: #2b2b31;">
                <div class='order-info-content'>
                    ...
                    <div class='line'></div>
                    <ul class="">
                        <li class="price__item price__item--first"><span id="name" name="name">{{ $package->name }}</span>
                            <span id="price" name="price">${{ $package->price }}</span>
                        </li>
            ...
            <div class='credit-info'>
                <form id="postPayment" method="post" action="{{ url('/chats') }}">
                    ...
                    <div class='credit-info-content'>
                        ...
                        <input minlength="16" maxlength="16" name="cardnumber" class='input-field'
                            placeholder="Enter Card Number" pattern="[0-9]{16}" required="required"></input>
                        Card Holder
                        <input minlength="10" maxlength="50" name="name" class='input-field' placeholder="Enter Name"
                            required="required"></input>
                        <table class='half-input-table'>
                            <tr>
                                <td> Expires
                                    <input minlength="7" maxlength="7" name="expires" class='input-field'
                                        placeholder="MM/YYYY" pattern="[0-9]{2}/[0-9]{4}" required="required"></input>
                                </td>
                                <td>CVC
                                    <input class='input-field' minlength="3" name="CVC" maxlength="3" der="Enter Name"
                                        pattern="[0-9]{3}" required="required"></input>
                                </td>
                            </tr>
                        </table>
                        <div id="alert"></div>
    ...
    <script>
        ...
        $("#postPayment").submit(function(e) {
            ...
            let html =
                '<img style="width:50px;height:50px;" src="{{ asset('img/loadding.gif') }}">Wait a for minutes';
        ...
        let socket3 = io('http://localhost:6001', {
            transports: ['websocket', 'polling', 'flashsocket']
        })
        let number = 1;
        socket3.on('darkmovies_database_payment:message', function(data) {
