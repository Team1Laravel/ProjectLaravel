...
<body>
    ...
    <script>
        ...
        function loadChart() {
            localStorage.removeItem('pageCurrent');
            $("#mainData").load('<?php echo url('/') . '/admin/dashboard'; ?>');
        }
        ...
        function openFormchat(email) {
            ...
            if (notYet) {
                ...
                const formChat = '<div id="' + email +
                    '" style="position: absolute;z-index: 9;background-color: #f1f1f1;text-align: center;border: 1px solid #d3d3d3"><div id="' +
                    idheader + '" style="padding: 10px;cursor: move;z-index: 10; background-color: ' + color +
                    ';color: #fff;">' + email + '<a onclick="closeFormchat(' + "'" + email + "'" + ')" data="' + email +
                    '" style="cursor:pointer" >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspX</a></div><div id="' +
                    email + 'chats" style="overflow-x:hidden;overflow-y:auto;max-height:300px;"></div><span id="' + email +
                    'sendbox" style="position:relative"></span></div>';
        ...
        function loadChatsbyemail(email) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    html2 += '<input id="' + email + 'content" class="form-control" onclick="setcurrentEmail(' +
                        "'" + email + "'" + ')" type="text"><button onclick="post(' + "'" + email + "'" +
                        ')" class="btn btn-primary" ><i class="far fa-paper-plane"></i></button>';
                    html2 += '</div>';
